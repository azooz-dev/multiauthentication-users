							...
							<div class="p-4">
                                ...
                                <form action="{{ route('admin.reset_password_submit') }}" method="POST">
                                    ...
                                    <div class="mb-3 mt-4">
                                        ...
                                        <input type="text" name="password" class="form-control @error('password') invalied @enderror" placeholder="Enter new password" />
                                        @error('password')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="password_confirmation" class="form-control @error('password') invalied @enderror" placeholder="Confirm password" />
